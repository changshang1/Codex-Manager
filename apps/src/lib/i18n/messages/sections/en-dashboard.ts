...
export const EN_DASHBOARD_MESSAGES: MessageCatalog = {
  ...
  不可用: "Unavailable",
  全部具体来源: "All individual sources",
  全部来源: "All sources",
  包含不可用来源: "Include unavailable sources",
  加载更多: "Load more",
  已删除: "Deleted",
  已选来源: "Selected",
  当前筛选无账号: "No accounts in the current filter",
  统计来源: "Usage sources",
  "以下筛选同时作用于 Token、请求、费用、趋势和账号池剩余":
    "These filters apply to tokens, requests, cost, trends, and account-pool quota",
  "搜索账号、来源 ID 或聚合 API": "Search accounts, source IDs, or aggregate APIs",
